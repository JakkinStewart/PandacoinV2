...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PandacoinV2 " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pandacoinv2tools.com", "192.168.254.71"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"pandacoinv2tools.com", "testnet-seed.pandacoinv2tools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PandacoinV2 is probably already running."), addrBind.ToString().c_str());
        else
